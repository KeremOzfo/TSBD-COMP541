# Rigorous Exploration: Handwriting

## Dataset Info

- **Sequence Length**: 152
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Handwriting_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Handwriting_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash Handwriting_all_methods.sh
```
...
head -200 Handwriting_all_methods.sh > Handwriting_subset.sh
bash Handwriting_subset.sh
```
