# Rigorous Exploration: SelfRegulationSCP2

## Dataset Info

- **Sequence Length**: 1152
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `SelfRegulationSCP2_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `SelfRegulationSCP2_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash SelfRegulationSCP2_all_methods.sh
```
...
head -200 SelfRegulationSCP2_all_methods.sh > SelfRegulationSCP2_subset.sh
bash SelfRegulationSCP2_subset.sh
```
