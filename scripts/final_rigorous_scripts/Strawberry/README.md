# Rigorous Exploration: Strawberry

## Dataset Info

- **Sequence Length**: 235
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Strawberry_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Strawberry_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash Strawberry_all_methods.sh
```
...
head -200 Strawberry_all_methods.sh > Strawberry_subset.sh
bash Strawberry_subset.sh
```
