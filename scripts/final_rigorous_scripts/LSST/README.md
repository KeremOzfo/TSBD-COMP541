# Rigorous Exploration: LSST

## Dataset Info

- **Sequence Length**: 36
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `LSST_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `LSST_all_methods.sh` (same file)
...
head -200 LSST_all_methods.sh > LSST_subset.sh
bash LSST_subset.sh
```
