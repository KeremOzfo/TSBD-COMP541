# Rigorous Exploration: PhonemeSpectra

## Dataset Info

- **Sequence Length**: 217
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `PhonemeSpectra_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `PhonemeSpectra_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash PhonemeSpectra_all_methods.sh
```
...
head -200 PhonemeSpectra_all_methods.sh > PhonemeSpectra_subset.sh
bash PhonemeSpectra_subset.sh
```
