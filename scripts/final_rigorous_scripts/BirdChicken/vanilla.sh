...
python -u main.py --train_mode backdoor --method vanilla --Tmodel cpatchtst --bd_type all2all --root_path ./dataset/BirdChicken --seq_len 512 --trigger_epochs 30 --bd_train_epochs 40 --warmup_epochs 0 --target_label 0 --auto_bd_arch True --auto_batch_size True --patch_len 32 --stride 16 --trigger_opt adam --trigger_lr 0.001 --trigger_weight_decay 0.0 --surrogate_opt sgd --surrogate_lr 0.01 --surrogate_weight_decay 0.0005 --surrogate_L2_penalty 0.0 --trigger_grad_clip 0.0 --surrogate_grad_clip 0.0 --poisoning_ratio 0.1
