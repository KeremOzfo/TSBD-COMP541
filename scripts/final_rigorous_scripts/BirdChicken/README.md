# Rigorous Exploration: BirdChicken

## Dataset Info

- **Sequence Length**: 512
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `BirdChicken_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `BirdChicken_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash BirdChicken_all_methods.sh
```
...
head -200 BirdChicken_all_methods.sh > BirdChicken_subset.sh
bash BirdChicken_subset.sh
```
