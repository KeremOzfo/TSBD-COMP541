# Rigorous Exploration: Haptics

## Dataset Info

- **Sequence Length**: 1092
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Haptics_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Haptics_all_methods.sh` (same file)
...
head -200 Haptics_all_methods.sh > Haptics_subset.sh
bash Haptics_subset.sh
```
