# Rigorous Exploration: MotorImagery

## Dataset Info

- **Sequence Length**: 3000
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `MotorImagery_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `MotorImagery_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash MotorImagery_all_methods.sh
```
...
head -200 MotorImagery_all_methods.sh > MotorImagery_subset.sh
bash MotorImagery_subset.sh
```
