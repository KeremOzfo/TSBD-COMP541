# Rigorous Exploration: SharePriceIncrease

## Dataset Info

- **Sequence Length**: 60
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `SharePriceIncrease_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `SharePriceIncrease_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash SharePriceIncrease_all_methods.sh
```
...
head -200 SharePriceIncrease_all_methods.sh > SharePriceIncrease_subset.sh
bash SharePriceIncrease_subset.sh
```
