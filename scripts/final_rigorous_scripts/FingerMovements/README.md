# Rigorous Exploration: FingerMovements

## Dataset Info

- **Sequence Length**: 50
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `FingerMovements_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `FingerMovements_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash FingerMovements_all_methods.sh
```
...
head -200 FingerMovements_all_methods.sh > FingerMovements_subset.sh
bash FingerMovements_subset.sh
```
