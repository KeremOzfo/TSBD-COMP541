# Rigorous Exploration: Sleep

## Dataset Info

- **Sequence Length**: 178
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Sleep_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Sleep_all_methods.sh` (same file)
...
head -200 Sleep_all_methods.sh > Sleep_subset.sh
bash Sleep_subset.sh
```
