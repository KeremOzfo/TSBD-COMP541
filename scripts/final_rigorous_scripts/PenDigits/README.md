# Rigorous Exploration: PenDigits

## Dataset Info

- **Sequence Length**: 8
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `PenDigits_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `PenDigits_all_methods.sh` (same file)
...
head -200 PenDigits_all_methods.sh > PenDigits_subset.sh
bash PenDigits_subset.sh
```
