# Rigorous Exploration: Cricket

## Dataset Info

- **Sequence Length**: 1197
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Cricket_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Cricket_all_methods.sh` (same file)
...
head -200 Cricket_all_methods.sh > Cricket_subset.sh
bash Cricket_subset.sh
```
