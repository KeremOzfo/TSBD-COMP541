# Rigorous Exploration: HandMovementDirection

## Dataset Info

- **Sequence Length**: 400
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `HandMovementDirection_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `HandMovementDirection_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash HandMovementDirection_all_methods.sh
```
...
head -200 HandMovementDirection_all_methods.sh > HandMovementDirection_subset.sh
bash HandMovementDirection_subset.sh
```
