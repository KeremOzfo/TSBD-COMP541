# Rigorous Exploration: CharacterTrajectories

## Dataset Info

- **Sequence Length**: 119
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `CharacterTrajectories_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `CharacterTrajectories_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash CharacterTrajectories_all_methods.sh
```
...
head -200 CharacterTrajectories_all_methods.sh > CharacterTrajectories_subset.sh
bash CharacterTrajectories_subset.sh
```
