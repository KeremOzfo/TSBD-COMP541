# Rigorous Exploration: WalkingSittingStanding

## Dataset Info

- **Sequence Length**: 206
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `WalkingSittingStanding_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `WalkingSittingStanding_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash WalkingSittingStanding_all_methods.sh
```
...
head -200 WalkingSittingStanding_all_methods.sh > WalkingSittingStanding_subset.sh
bash WalkingSittingStanding_subset.sh
```
