# Rigorous Exploration: ECG5000

## Dataset Info

- **Sequence Length**: 140
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `ECG5000_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `ECG5000_all_methods.sh` (same file)
...
head -200 ECG5000_all_methods.sh > ECG5000_subset.sh
bash ECG5000_subset.sh
```
