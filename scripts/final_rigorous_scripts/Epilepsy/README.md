# Rigorous Exploration: Epilepsy

## Dataset Info

- **Sequence Length**: 206
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Epilepsy_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Epilepsy_all_methods.sh` (same file)
...
head -200 Epilepsy_all_methods.sh > Epilepsy_subset.sh
bash Epilepsy_subset.sh
```
