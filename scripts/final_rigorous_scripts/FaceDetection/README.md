# Rigorous Exploration: FaceDetection

## Dataset Info

- **Sequence Length**: 62
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `FaceDetection_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `FaceDetection_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash FaceDetection_all_methods.sh
```
...
head -200 FaceDetection_all_methods.sh > FaceDetection_subset.sh
bash FaceDetection_subset.sh
```
