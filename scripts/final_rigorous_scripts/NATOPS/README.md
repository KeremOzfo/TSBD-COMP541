# Rigorous Exploration: NATOPS

## Dataset Info

- **Sequence Length**: 51
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `NATOPS_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `NATOPS_all_methods.sh` (same file)
...
head -200 NATOPS_all_methods.sh > NATOPS_subset.sh
bash NATOPS_subset.sh
```
