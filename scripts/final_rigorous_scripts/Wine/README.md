# Rigorous Exploration: Wine

## Dataset Info

- **Sequence Length**: 234
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `Wine_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `Wine_all_methods.sh` (same file)
...
head -200 Wine_all_methods.sh > Wine_subset.sh
bash Wine_subset.sh
```
