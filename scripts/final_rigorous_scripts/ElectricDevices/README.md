# Rigorous Exploration: ElectricDevices

## Dataset Info

- **Sequence Length**: 96
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `ElectricDevices_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `ElectricDevices_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash ElectricDevices_all_methods.sh
```
...
head -200 ElectricDevices_all_methods.sh > ElectricDevices_subset.sh
bash ElectricDevices_subset.sh
```
