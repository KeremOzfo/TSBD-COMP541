# Rigorous Exploration: BasicMotions

## Dataset Info

- **Sequence Length**: 100
- **Master script (calls all methods)**: `run_all_methods.sh`
- **Combined script (concatenated)**: `BasicMotions_all_methods.sh`
...
- **All methods (concatenated)**: `run_all_methods.sh` or `BasicMotions_all_methods.sh` (same file)
...
bash run_all_methods.sh
# OR
bash BasicMotions_all_methods.sh
```
...
head -200 BasicMotions_all_methods.sh > BasicMotions_subset.sh
bash BasicMotions_subset.sh
```
